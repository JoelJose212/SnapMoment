        ...
        <section className="pb-24 px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { name: 'Fresher', price: '₹50', delay: 0, features: ['5 events/month', '200 photos/event', 'QR + OTP flow', 'Branded watermark', 'Email support'], cta: 'Fresher', highlighted: false, tag: null },
